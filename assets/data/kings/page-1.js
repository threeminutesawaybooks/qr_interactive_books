window.BookPlatform.registerPageData({
  book: "kings",
  page: 1,
  title: "Kings Page 1 Quiz",
  type: "quiz",
  metaDescription: "Sample quiz page for the Oops book.",
  metaImage: "https://ik.imagekit.io/imaginetamilfc/Flash%20Cards%20-%20IT/Flash%20Card%20Images/F12%20-%20Birds/1.jpg",
  payload: {
    activityTitle: "Bimbisara Quiz",
    completion: {
      title: "Great job!",
      message: "Hope you learned from Bimbisara’s story."
    },
    questions: [
  {
  ...
  },
  {
    ...
    options: [
      "Through magic and treasure",
      "By building taller palaces",
      "Through diplomacy and alliances",
      "By travelling to other countries"
    ]
  },
  {
    image: "https://ik.imagekit.io/Threeminutesaway/Books/Kings/Question.jpg",
    ...
    options: [
      "Solving problems through discussion and cooperation",
      "Winning every problem through war",
      "Keeping secrets from everyone",
      "Building a very large army"
    ]
  },
  {
    image: "https://ik.imagekit.io/Threeminutesaway/Books/Kings/Question.jpg",
  ...
  },
  {
    ...
    options: [
      ...
      "It was surrounded by a large ocean",
      "It was protected by magical gates",
      "It was surrounded by hills and protected by stone walls"
    ]
  },
  {
    image: "https://ik.imagekit.io/Threeminutesaway/Books/Kings/Question.jpg",
  ...
  },
  {
    ...
    options: [
      ...
      "He wanted to rule another kingdom",
      "He wanted to find the path to enlightenment",
      "He wanted to collect more treasure"
    ]
  },
  {
    image: "https://ik.imagekit.io/Threeminutesaway/Books/Kings/Question.jpg",
    ...
    options: [
      "He supported monasteries and helped spread the teachings",
      "He asked everyone to become soldiers",
      "He closed all places of learning",
      "He stopped people from visiting the Buddha"
    ]
  },
  {
    image: "https://ik.imagekit.io/Threeminutesaway/Books/Kings/Question.jpg",
    ...
    options: [
      ...
      "Talk to them and find a peaceful solution",
  ...
  },
  {
    ...
    options: [
      "A king should fight every battle",
      "Only a large army can earn respect",
      "Wisdom and respect can be more powerful than force",
      "Power is more important than kindness"
    ]
  }
]
  }
